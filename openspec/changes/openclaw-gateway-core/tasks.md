...
- [x] 13.1 **DECIDED by Justin, 2026-08-01: keep the app's five commands plus `/status` and `/models`, prune the rest.** He wants to diagnose the gateway from the phone without opening a terminal, which is why this is not the clean "prune everything of theirs" I recommended. Original finding follows.
