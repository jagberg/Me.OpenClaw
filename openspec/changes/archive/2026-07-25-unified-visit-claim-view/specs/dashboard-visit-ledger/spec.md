...
- **WHEN** the first claim for a given condition in a policy year has a claimable subtotal above the excess (Aari: $150 per condition per year)
...
- **WHEN** a pet's prior reimbursements in the policy year approach the annual cap (Aari: $10,000/year)
